        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatingDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Information1 = table.Column<string>(type: "text", nullable: true),
                    Information2 = table.Column<string>(type: "text", nullable: true),
                    Information3 = table.Column<string>(type: "text", nullable: true),
                    Information4 = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    User = table.Column<string>(type: "text", nullable: true),
                    TicketDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdminReply = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "2eb38ed5-d69e-4ce4-b80b-0bed8d68269c", "Member", "MEMBER" },
                    { 2, "988ff226-1fa4-4906-9333-f8f001dddead", "Admin", "ADMIN" }
                });
