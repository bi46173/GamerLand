...
{
    public partial class ContactsEntity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Information1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Information2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Information3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Information4 = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "6ae79d5c-6473-4b8b-8ffe-3680fe755818", "Member", "MEMBER" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { 2, "492ba31e-ec88-45fd-8291-7fd0c5d59f1c", "Admin", "ADMIN" });
